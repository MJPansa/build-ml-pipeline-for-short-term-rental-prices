...
def go(args):
    ...
    logger.info(trainval_local_path)

    X = pd.read_csv(trainval_local_path, engine='python')
    ...
    new_artifact = wandb.Artifact(
        ...
        type="model_export",
        description='the fitted RF model',
        metadata=rf_config
    )

    new_artifact.add_dir('random_forest_dir')
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    sk_pipe = Pipeline([('preprocessor', preprocessor), ('random_forest', random_Forest)])
